(function () {
  ...
  const STORAGE = {
    query: 'hankkiRouteJapan.query.v5',
    plan: 'hankkiRouteJapan.plan.v5',
    admin: 'hankkiRouteJapan.admin.v5',
    adminSession: 'hankkiRouteJapan.adminSession.v5',
    forceDemo: 'hankkiRouteJapan.forceDemo.v5',
    basePoint: 'hankkiRouteJapan.basePoint.v5',
    uiView: 'hankkiRouteJapan.uiView.v1',
  };
  ...
  function cache() {
    ids([
      ...
      'search-view', 'plan-view', 'plan-summary'
  ...
  function bind() {
    ...
    els.autoPlanButton.addEventListener('click', function () {
      autoFillPlan();
      setView('plan');
    });
